...
const Page = () => {
  ...
  return (
    <div>
      <div>
        <Navbar />
        <div className="px-5 md:px-20 mt-[2rem] " id="gallery">
          <div className=" flex items-center justify-center mt-[6rem]   gap-2">
      ...
      {select !== 0 && (
        <div className="fixed top-[50%] left-0 w-full  p-8">
          <div className=" top-0 left-0 w-full h-full z-50 bg-[#00000099] fixed backdrop-blur-[1px]"></div>
          <div className="absolute top-[50%]  z-[100] w-[80%] lg:w-[30%] bg-slate-500 left-[50%] p-8 translate-x-[-50%] translate-y-[-50%]">
            <div
            ...
            <div className="flex justify-center items-center">
              {
                <Image
                  ...
                  className="w-[90%] h-full lg:h-[400px] object-cover lg:object-contain"
                  alt="imageclicked"
                  width={200}
                  height={200}
                />
