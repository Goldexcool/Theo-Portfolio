    ...
    <main>
      <section className='flex items-center justify-center px-5 md:px-20  mt-[5rem]'>
        <div>
          ...
          <article className=' gap-4 lg:gap-[0rem]  lg:flex-row flex-wrap justify-center items-center  lg:justify-between w-full  flex-col flex text-main-black'>
            <div className='flex items-center flex-col lg:w-1/2 w-full gap-3 '>
              ...
              <h2 className='md:text-[19px] text-[15px] lg:text-left text-center'> At <span className='text-main-blue text-[17px] '>THEO UNITED</span> we are committed to providing exceptional thermal insulation services. Our team brings together over 12 years of individual experience, each member having worked at management levels in various establishments. </h2>
              <h3 className='mt-3 mb-4 md:text-[19px] text-[15px] lg:text-left text-center'>Our collective expertise is now united under a single corporate body to ensure our prospective clients&apos; satisfaction with our services.</h3>
              <h4 className='md:text-[19px] text-[15px] lg:text-left text-center'>
            ...
            <div className='lg:block lg:w-fit w-full flex justify-center items-center'>
              <Image className="w-full" src={about} alt="" width={500} height={200} className='h-[500px] rounded-[30px] mb-4 w-[500px]' />
            </div>
        ...
        <div className=''>
          ...
          <article className=' flex flex-wrap items-center justify-center lg:justify-between lg:w-full lg:flex-row flex-col-reverse gap-4 md:gap-[0px] text-main-black'>
            ...
            <div className='lg:block flex justify-center mt-4 lg:mt-0 items-center'>
              <Image src={about3} className="" alt="" width={500} height={200} className='h-[500px] rounded-[30px] mb-4 w-[500px]' />
            </div>
